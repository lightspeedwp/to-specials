...
<article id="special-<?php echo esc_attr( $post->post_name ); ?>" <?php post_class( 'lsx-to-archive-container' ); ?>>
	...
	<?php if ( is_single() && false === $lsx_to_archive ) { ?>
		...
		<div <?php lsx_to_entry_class( 'entry-content' ); ?>>
			...
			<?php lsx_to_price( '<p class="lsx-to-meta-data lsx-to-meta-data-big lsx-to-meta-data-price"><span class="lsx-to-meta-data-key">' . esc_html__( 'From price', 'to-specials' ) . ':</span> ', '</p>' ); ?>
			<?php the_content(); ?>
			<?php lsx_to_sharing(); ?>
		</div>
