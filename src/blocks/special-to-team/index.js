/**
 * Special to Team Block Variation
 *
 * @since 2.2.0
 * @package TO_Specials
 */
...
wp.domReady(() => {
    const registerSpecialToTeamVariation = () => {
        wp.blocks.registerBlockVariation('core/group', {
            name: 'lsx-tour-operator/special-to-team',
            title: __('Special to Team', 'to-specials'),
            icon: 'admin-users',
    ...
    const conditionalRegister = registerForPostTypesAndTemplates(['special'], ['special'], registerSpecialToTeamVariation);
    conditionalRegister();
});
