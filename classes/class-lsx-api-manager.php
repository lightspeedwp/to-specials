...
class LSX_API_Manager {
	...
	public function dashboard_tabs($tab='general') {
		...
		if('active' === $this->status){
			...
			$description = __( 'You can find your key on your <a target="_blank" rel="noopener noreferrer" href="https://www.lsdev.biz/my-account/">My Account</a> page.', $this->product_slug );
		}
