...
We've also made a fantastic [theme](https://lsx.design/) that work well with the Tour Operator Specials plugin.
...
= Support =
We offer premium support for this plugin. Premium support that can be purchased via [lightspeedwp.agency](https://lightspeedwp.agency/).

== Installation ==

1. Upload the plugin files to the `/wp-content/plugins/to-specials` directory, or install the plugin through the WordPress plugins screen directly.
...
Bugs can be reported either in our support forum or preferably on the [Tour Operator Specials GitHub repository](https://github.com/lightspeeddevelopment/to-specials/issues/).

= The Tour Operator Specials plugin is awesome! Can I contribute? =
Yes you can! Join in on our [GitHub repository](https://github.com/lightspeeddevelopment/to-specials/) :)
